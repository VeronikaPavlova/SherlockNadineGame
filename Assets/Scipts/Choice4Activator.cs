...
public class Choice4Activator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (canActivate && triggerOrKey && !Choice4Manager.instance.ChoiceBox.activeInHierarchy && checkedQuest && leaveTriggerArea)
        {
            if (triggerOnes)
            {
                triggerOrKey = false;
            ...
            Choice4Manager.instance.ShowChoice(question, question2, text1, text2, text3, text4, questToMark1, questToMark2, questToMark3, questToMark4);
